...
public class OfficeXToText
{
    ...
    public static String extract(String fn) throws Exception
    {
        try
        {
            ...
            OOXMLBodyHandler handler = new OOXMLBodyHandler();
        ...
        {
            System.err.println("Unable to extract text from Word file " + fn);
            ex.printStackTrace();
            return null;
        }
    }

    public static class OOXMLBodyHandler implements org.xml.sax.ContentHandler
    {
